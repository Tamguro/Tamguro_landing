...
export default function Hero(): JSX.Element {
  return (
    <section
      id="hero"
      className="flex flex-col items-start gap-[56px] overflow-hidden bg-white px-[20px] py-[64px] md:px-[80px] md:py-[96px] lg:flex-row lg:items-center lg:justify-between lg:gap-[40px]"
    >
      {/* Text column */}
